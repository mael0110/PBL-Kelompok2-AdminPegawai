  ...
  <div class="min-h-screen bg-blue-900 flex items-center justify-center">
    <div class="w-[430px] bg-white rounded-xl shadow-lg px-20 py-14">
      <div class="text-center mb-10">
        ...
        <p class="text-xs text-gray-600">Silahkan Login Untuk Melanjutkan</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-4">
        <div>
          <p
            v-if="errorMessage"
            class="bg-[#E74C3C] text-white text-sm px-4 py-3 rounded-md mb-3 flex items-center justify-between"
          >
            {{ errorMessage }}
          ...
          <div
            class="flex items-center bg-white border border-gray-300 rounded h-8"
          >
            ...
            <input
              ...
              type="email"
              placeholder="Email"
              class="w-full outline-none text-xs px-2"
            />
          </div>
        </div>
        ...
        <button
          type="submit"
          class="w-full bg-blue-900 text-white text-sm py-2 rounded hover:bg-blue-800"
        >
          Masuk
        </button>
      </form>
