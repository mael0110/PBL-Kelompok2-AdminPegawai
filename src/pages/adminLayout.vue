    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <aside v-if="showSidebar" class="w-56 bg-blue-100 h-full p-4 flex flex-col">
        <nav class="space-y-2 flex-1">
          ...
          <RouterLink to="/pegawai" class="menu-link"><User :size="16" /><span>Pegawai</span></RouterLink>
          <RouterLink to="/verifikasi" class="menu-link"><CircleCheck :size="16" /><span>Verifikasi</span></RouterLink>
          <RouterLink to="/presensi" class="menu-link"><MonitorCheck :size="16" /><span>Presensi</span></RouterLink>
          <RouterLink to="/penjadwalan" class="menu-link"><CalendarDays :size="16" /><span>Penjadwalan</span></RouterLink>
        </nav>
