      ...
      <form class="grid grid-cols-2 gap-4" @submit.prevent="updatePegawai">
        ...
        <div class="col-span-2">
          ...
          <div>
            ...
            <select v-model="form.province_code" @change="handleProvinceChange" class="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-blue-500 outline-none">
          ...
          <div>
            ...
            <select v-model="form.city_code" @change="handleCityChange" class="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-blue-500 outline-none">
          ...
          <div>
            ...
            <select v-model="form.district_code" @change="handleDistrictChange" class="w-full border rounded-lg px-3 py-2 mb-4 focus:ring-2 focus:ring-blue-500 outline-none">
