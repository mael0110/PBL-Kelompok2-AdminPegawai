...
<template>
  <AdminLayout>
    <div>
      <h1 class="text-lg font-bold mb-3 text-gray-800">VERIFIKASI</h1>
      ...
      <div class="flex gap-3 mb-4">
        <div class="relative flex-1 text-[11px]">
          ...
          <input
            ...
            class="w-full border border-blue-900 rounded-md pl-9 pr-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-200"
          />
        </div>
        ...
        <div class="relative">
          ...
          <select
            ...
            class="bg-blue-900 border border-blue-900 text-[11px] text-white pl-9 pr-7 py-1.5 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-200 cursor-pointer"
          >
      ...
      <div class="bg-white rounded-xl shadow-md px-4">
        <div class="px-4 py-2">
          <h4 class="font-bold text-[11px] text-gray-800">DAFTAR VERIFIKASI</h4>
        </div>
        ...
        <table class="w-full table-dashboard text-[11px] border-b border-gray-200">
          <thead>
            <tr class="bg-blue-200 font-semibold">
              ...
              <th class="p-1.5 text-left">AKSI</th>
            </tr>
          </thead>
          <tbody>
            <tr
            ...
            >
              ...
              <td class="p-1.5 font-semibold">
                {{ item.employee.employee_name }}
              </td>
              <td class="p-1.5 font-semibold">{{ item.employee.nip }}</td>
              <td class="p-1.5 font-semibold">{{ item.employee.nik }}</td>
              <td class="p-1.5 font-semibold text-left">
                <span
              ...
              <td class="p-1.5 text-left">
                <button
                  ...
                  "
                  class="w-[75px] inline-block text-center bg-blue-900 hover:bg-blue-950 text-white px-2 py-1 rounded-md text-[10px] font-semibold"
                >
                  VERIFIKASI
                </button>
              </td>
